...
public class SendToUser extends AppCompatActivity {
    ...
    com.example.mybank.CustomeAdapterSendToUser adapter;
    ...
    private void showData(String phonenumber) {
        ...
        adapter = new com.example.mybank.CustomeAdapterSendToUser(com.example.mybank.SendToUser.this, modelList_sendtouser);
    ...
    public void selectuser(int position) {
       selectuser_phonenumber = modelList_sendtouser.get(position).getPhoneno();
        ...
        while(cursor.moveToNext()) {
            ...
            startActivity(new Intent(com.example.mybank.SendToUser.this, Userlist.class));
            finish();
        }
    }
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder_exitbutton = new AlertDialog.Builder(com.example.mybank.SendToUser.this);
        builder_exitbutton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        new DatabaseHelper(com.example.mybank.SendToUser.this).insertTransferData(date, name, "Not selected", transferamount, "Failed");
                        Toast.makeText(com.example.mybank.SendToUser.this, "Transaction Cancelled!", Toast.LENGTH_LONG).show();
                        startActivity(new Intent(com.example.mybank.SendToUser.this, Userlist.class));
                        finish();
                    }
